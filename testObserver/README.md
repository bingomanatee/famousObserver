#testObserver
> Testing tehe observer in basic use cases.

[![Build Status](https://travis-ci.org/bingomanatee/testobserver.svg?branch=master)](https://travis-ci.org/bingomanatee/testobserver) [![Dependency Status](https://david-dm.org/bingomanatee/testobserver.svg)](https://david-dm.org/bingomanatee/testobserver) [![devDependency Status](https://david-dm.org/bingomanatee/testobserver.svg)](https://david-dm.org/bingomanatee/testobserver#info=devDependencies)
...
## Release History
 * 2014-05-04   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)